  ...
  return (
    <footer className="ml-20 bg-neutral-100 text-center text-neutral-600 dark:bg-gray-900 dark:text-neutral-200 lg:text-left ">
        <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-blue-900 lg:justify-center">
            ...
            {/* <!-- Social neTYLONs17ork icons container --> */}
        ...
        {/* <!-- Main container div: holds the entire content of the footer, including four sections (TYLONs17 elements, Products, Useful links, and Contact), with responsive styling and appropriate padding/margins. --> */}
        <div className="mx-6 py-10 text-center md:text-left">
            <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {/* <!-- TYLONs17 elements section --> */}
            <div className="">
            ...
            <div className="">
                ...
                <p className="mb-4">
                    <a href="#!" className="text-neutral-600 dark:text-neutral-200">Next.js</a>
                </p>
                <p className="mb-4">
                    <a href="#!" className="text-neutral-600 dark:text-neutral-200">ASP.NET MVC</a>
                </p>
                {/* <p>
                    <a href="#!" className="text-neutral-600 dark:text-neutral-200">Angula</a>
                </p> */}
            </div>
            ...
            <div className="">
                ...
                <p className="mb-4">
                    <a href="#!" className="text-neutral-600 dark:text-neutral-200">Games</a>
                </p>
                <p className="mb-4">
                    <a href="#!" className="text-neutral-600 dark:text-neutral-200">Music</a>
                </p>
                <p className="mb-4">
                    <a href="#!" className="text-neutral-600 dark:text-neutral-200">Works</a>
                </p>
                <p>
        ...
        {/* <!--Copyright section--> */}
        <div className="bg-neutral-200 p-6 text-2xl text-center text-blue-700 font-bold dark:bg-gray-800">
            <span>© 2023 TYLONs17&trade;</span> 
            {/* TODO: make this link to T17 deployed portfolio */}
        </div>
    </footer>
  )
}
